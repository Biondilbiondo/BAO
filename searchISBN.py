...
def stripFirstAndLast10Pages( infile, outfile ):
    ...
    try:
        ...
        if settings.verbosity_level_numeric > 0:
            print '[stripping]\tNon e\' stato possibile aprire il file di input specificato, controlla l\'indirizzo e i permessi',
    ...
    try:
        ...
        if settings.verbosity_level_numeric > 0:
            print '[stripping]\tNon e\' stato possibile creare il file di output specificato, controlla i permessi',
